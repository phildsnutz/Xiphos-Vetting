...
def test_render_ownership_control_summary_surfaces_gap_descriptor_and_evidence():
    ...
    html = dossier._render_ownership_control_summary(
        {
            "analyst_readout": "Descriptor-only ownership evidence. No named beneficial owner resolved. Owner class: Service-Disabled Veteran.",
            "oci": {
    ...
    assert "Descriptor-only ownership evidence. No named beneficial owner resolved." in html
