...
export function DemoCompare() {
  ...
  return (
    <div style={{ maxWidth: 1040, margin: "0 auto", padding: "0 16px" }}>
        ...
        <div className="mt-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span
              ...
              style={{ fontSize: FS.sm, background: T.raised, color: T.muted }}
            >
            ...
            {enrichedProfiles && (
              <span
                className="font-mono rounded px-1.5 py-0.5"
                style={{ fontSize: FS.sm, background: T.accent + "18", color: T.accent }}
              >
                OSINT ENRICHED
              </span>
            )}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="font-mono font-bold" style={{ fontSize: FS.sm, color: color }}>
                      {label}
                    </span>
                  </div>
                  ...
                  {isExpanded && (
                    <div
                      className="mt-2 pt-2"
                      style={{ borderTop: `1px solid ${T.border}`, fontSize: FS.sm, color: T.dim }}
                    >
                      <div className="mb-1">
              ...
              return (
                <div className="grid grid-cols-3 gap-4 mt-1">
                  <div>
                    ...
                    <div style={{ fontSize: FS.sm, color: T.muted }}>Distinct Tiers</div>
                  </div>
                  <div>
                    <div className="font-mono font-bold" style={{ fontSize: FS.lg, color: T.text }}>
                      {Math.round(min * 100)}% - {Math.round(max * 100)}%
                    </div>
                    <div style={{ fontSize: FS.sm, color: T.muted }}>Probability Range</div>
                  </div>
                  <div>
                    <div className="font-mono font-bold" style={{ fontSize: FS.lg, color: T.text }}>
                      {Math.round(spread * 100)}pp
                    </div>
                    <div style={{ fontSize: FS.sm, color: T.muted }}>Risk Spread</div>
                  </div>
                </div>
              );
            })()}
          ...
          {enrichPhase === "idle" && !enrichedProfiles && (
            <div className="text-center mt-5">
              ...
              <p style={{ fontSize: FS.sm, color: T.muted, marginTop: 8 }}>
              ...
              >
                ...
                <div className="grid grid-cols-4 gap-3 mt-3">
                  ...
                  <div className="text-center">
                    ...
                    <div style={{ fontSize: FS.sm, color: T.muted }}>Peak Risk</div>
                  </div>
                </div>
              </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            ...
                            style={{ fontSize: FS.sm, color: c.state === "running" ? T.text : T.dim }}
                          >
                            {label}
                          </span>
                          {c.state === "done" && (
      ...
      {!result && !loading && (
        <div className="mt-8">
          <div style={{ fontSize: FS.sm, color: T.muted, marginBottom: 8, textAlign: "center" }}>
            Try these examples:
          </div>
