...
import { T, FS, FX, TIER_META, parseTier, tierBand, probLabel, displayName } from "@/lib/tokens";
import { ChevronLeft, FileText, Activity, Globe, Clock, XCircle, AlertTriangle, Loader2, Radar, Lock, MoreHorizontal, Network, CheckCircle, Brain, Upload, Shield } from "lucide-react";
...
import { formatFactorLabel, formatFindingCopy, formatRelationshipLabel } from "@/lib/workflow-copy";
