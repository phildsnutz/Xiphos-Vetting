        ...
        >
          ...
          <div className="flex items-center gap-4">
            <span style={{ fontSize: FS.sm, color: T.dim }}>
              Posterior: <strong style={{ color: T.text }}>{Math.round(cal.p * 100)}%</strong>
            </span>
            <span style={{ fontSize: FS.sm, color: T.dim }}>
              Rubric: <strong style={{ color: T.text }}>{c.sc}/100</strong>
            </span>
            <span style={{ fontSize: FS.sm, color: T.dim }}>
              Coverage: <strong style={{ color: T.text }}>{Math.round(cal.cov * 100)}%</strong>
            </span>
          </div>
        </div>
      )}
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div style={{ fontSize: FS.xs, color: "#fca5a5", marginTop: 6, opacity: 0.8 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-lg p-5" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
              ...
              <div style={{ fontSize: FS.xs, color: T.muted, marginBottom: 10 }}>
              ...
              <div className="rounded-lg p-4" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
                ...
                {sortedCt.map((ct, i) => (
                  ...
                  >
                    ...
                    <div style={{ fontSize: FS.xs, color: T.muted, marginTop: 3 }}>{ct.d}</div>
                  </div>
                ))}
              </div>
            )}
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="rounded-lg p-4" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
              ...
              <div style={{ padding: "10px 0 0", marginTop: 6 }}>
                ...
                <div style={{ fontSize: FS.xs, color: T.muted, marginBottom: 6 }}>
                ...
                <div className="flex items-baseline gap-1 mb-2">
                  ...
                  <span className="font-mono ml-2" style={{ fontSize: FS.xs, color: T.muted }}>
                  ...
                  if (divergence > 15) {
                    return (
                      ...
                      >
                        ...
                        <span style={{ fontSize: FS.xs, color: T.amber }}>
                ...
                {cal.miv.map((m, i) => (
                  ...
                  >
                    ...
                    <div className="flex gap-3 mt-1.5">
                      <span className="font-mono" style={{ fontSize: FS.xs, color: T.accent }}>
