...
def build_training_dashboard_payload() -> dict:
    ...
    return {
        ...
        "live_tranche": {
            ...
            "masked_holdout_queries_evaluated": int(missing_edge.get("masked_holdout_queries_evaluated") or 0),
            "mean_withheld_target_rank": float(missing_edge.get("mean_withheld_target_rank") or 0.0),
            "masked_holdout_hits_at_10": float(missing_edge.get("masked_holdout_hits_at_10") or 0.0),
