...
def get_export_evidence_summary(case_id: str, case_input: dict[str, Any] | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "destination_company": str(case_input.get("destination_company") or "").strip(),
        ...
        "item_or_data_summary": str(case_input.get("item_or_data_summary") or "").strip(),
        "end_use_summary": str(case_input.get("end_use_summary") or "").strip(),
        "access_context": str(case_input.get("access_context") or "").strip(),
        "notes": str(case_input.get("notes") or "").strip(),
